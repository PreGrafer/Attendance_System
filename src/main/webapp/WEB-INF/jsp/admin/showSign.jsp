...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="all"
          href="<%=request.getContextPath()%>/css/daterangepicker-bs3.css"/>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <form class="form-horizontal" style="margin: 20px 0 10px 0;" role="form"
                              action="<%=request.getContextPath()%>/admin/loadReportInfoData" id="querySign"
                              method="post">
                                        ...
                                        <div class="controls">
                                            <div class="input-prepend input-group">
                                                ...
                                                <input type="text" name="createDate" id="createDate"
                                                       class="form-control span4 text-center"
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-default btn-xs btn-info"
                                        onClick="location.href='javascript:showDetail(${item.reportId})'">详细
                                </button>
                                <!--弹出框-->
                            </td>
                        </tr>
                ...
                <div class="modal fade" id="reportDetail" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                     aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <table class="table table-bordered">
                                    ...
                                    <tbody id="reportDetailGrid"></tbody>
                                </table>
                            </div>
...
<script type="text/javascript">
    ...
    function showDetail(reportId) {
        // $("#reportDetailGrid").remove()
        var url = '<%=request.getContextPath()%>/admin/loadReportDetailData';
        $.ajax({
            url: url, type: "POST", data: {reportId: reportId}, dataType: "json",
            success: function (data) {

                $('#reportDetail').modal('show');
                $("#reportDetailGrid").html('')
